...
<%
    ...
    try{
        ...
        String query1 = "SELECT * from fiveminutes where vmname='T09_VM01_Lab3'and timeinserted>'"+dateFormat.format(cal.getTime())+"'";
        String query2 = "SELECT * from fiveminutes where vmname='T09_VM02_Lab4'and timeinserted>'"+dateFormat.format(cal.getTime())+"'";
        String query3 = "SELECT * from fiveminutes where vmname='T09_VM03_Lab4'and timeinserted>'"+dateFormat.format(cal.getTime())+"'";
       //String query3 = "SELECT cpu,,mem,iowrite,network,vmname from fiveminutes where vmname='T09_VM03_Lab4' and timeinserted>'"+cal.getTime()+"'";
        ...
        while (rs1.next()) {
            ...
            int thread =rs1.getInt("noofthreads");
        ...
        while (rs2.next()) {
            ...
            int thread =rs2.getInt("noofthreads");
        ...
        while (rs3.next()) {
            ...
            int thread = rs3.getInt("noofthreads");
            empObj = new JSONObject();
            empObj.put("vmname", vmname);
            empObj.put("cpu", cpu);
            empObj.put("mem", mem);
