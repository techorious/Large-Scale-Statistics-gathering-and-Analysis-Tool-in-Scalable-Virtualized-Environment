...
<%
    ...
    try{
        ...
        String query1 = "SELECT * from 24hour where vmname='T09_VM01_Lab3'and timeinserted>'"+dateFormat.format(cal.getTime())+"'";
        String query2 = "SELECT * from 24hour where vmname='T09_VM02_Lab4'and timeinserted>'"+dateFormat.format(cal.getTime())+"'";
        String query3 = "SELECT * from 24hour where vmname='T09_VM03_Lab4'and timeinserted>'"+dateFormat.format(cal.getTime())+"'";
